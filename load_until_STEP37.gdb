...
command
        set m_pPageTable0Default->m_pTable[ $Alpha_address / 0x100000 ].XNBit = 0
        continue
end
...
# Recall Alpha with Circle Exception
...
tbreak *CSerialDevice::CSerialDevice(CInterruptSystem*, bool) 
command
       p/x $cpsr
